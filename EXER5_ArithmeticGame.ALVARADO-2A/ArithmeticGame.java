...
public class ArithmeticGame extends JFrame implements ActionListener {
    ...
    private static final Font TITLE_FONT = new Font("SansSerif", Font.BOLD, 35);
    private static final Font BODY_FONT = new Font("SansSerif", Font.PLAIN, 35);
    ...
    private JPanel createMainPanel() {
        ...
        // 🔥 Make the correct score BIGGER
        correctScoreLabel.setFont(new Font("SansSerif", Font.BOLD, 45));
        ...
        // 🔥 Make the incorrect score BIGGER
        incorrectScoreLabel.setFont(new Font("SansSerif", Font.BOLD, 45));
